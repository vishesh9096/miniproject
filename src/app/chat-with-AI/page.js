...
export default function Chat_with_AI() {
    return(
...
const ChatUpper = () => {
    return(
        <div className="tutorial bg-gray-100 px-8">
        ...
        <div className="flex sm:items-center justify-between py-3 border-b-2 border-gray-500">
          <div className="relative flex items-center space-x-4">
            <div className="relative">
              ...
              <img src="https://media.istockphoto.com/id/1128516744/vector/robot-icon-bot-sign-design-chatbot-symbol-concept-voice-support-service-bot-online-support.jpg?s=612x612&w=0&k=20&c=Z8MetVg7f2qkrg6pEBl2LOvqGcZp8z46YE-QywHIP8A=" alt="" className="w-10 sm:w-16 h-10 sm:h-16 rounded-full" />
            </div>
            <div className="flex flex-col leading-tight">
              <div className="text-2xl mt-1 flex items-center">
                <span className="text-gray-700 mr-3">Safety Expert</span>
              </div>
              <span className="text-lg text-gray-600">AI</span>
            </div>
          </div>
